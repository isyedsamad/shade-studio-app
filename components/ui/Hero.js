...
const Hero = () => {
  return (
    <>
        <div className='flex justify-center items-center py-25 flex-col'>
            <div className='max-w-2xl flex justify-center items-center flex-col'>
                ...
                <div className='flex justify-center items-center gap-4 mt-5'>
                    ...
                    <button className='bg-gray-200 text-[var(--text-primary)] font-medium px-5 py-2 cursor-pointer hover:bg-gray-300 rounded-lg text-sm'>Modify Background</button>
                </div>
            </div>
        </div>
    </>
